<?php
//Enable Loader
$wp_customize->add_setting( 'top_store_pro_preloader_enable', array(
                'default'               => false,
                'sanitize_callback'     => 'top_store_sanitize_checkbox',
            ) );
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'top_store_pro_preloader_enable', array(
                'label'                 => esc_html__('Enable Loader', 'top-store-pro'),
                'type'                  => 'checkbox',
                'section'               => 'top-store-pre-loader',
                'settings'              => 'top_store_pro_preloader_enable',
                'priority'   => 1,
            ) ) );
// BG color
...
// Pre loader Image
/*******************/ 
$wp_customize->add_setting('top_store_pro_preloader_image_upload', array(
        'default'       => TOP_STORE_PRELOADER,
        'capability'    => 'edit_theme_options',
        'sanitize_callback' => 'top_store_sanitize_upload',
    ));
$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize, 'top_store_pro_preloader_image_upload', array(
        'label'          => __('Pre Loader Image', 'top-store-pro'),
        'description'    => __('(You can also use GIF image.)', 'top-store-pro'),
        'section'        => 'top-store-pre-loader',
        'settings'       => 'top_store_pro_preloader_image_upload',
 )));
...
$wp_customize->add_control(new top_store_Misc_Control( $wp_customize, 'top_store_loader_link_more',
        ...
        'section'     => 'top-store-pre-loader',
        'type'        => 'doc-link',
        'url'         => 'https://themehunk.com/docs/top-store-pro/#pre-loader',
