...
$wp_customize->add_setting('top_store_product_slider_heading', array(
	    'default' => __('Product Carousel','top-store-pro'),
...
// Add an option to disable the logo.
  ...
  $wp_customize->add_setting('top_store_product_slider_speed', array(
        'default' =>'3000',
        'capability'        => 'edit_theme_options',
        'sanitize_callback' => 'top_store_sanitize_number',
));
$wp_customize->add_control( 'top_store_product_slider_speed', array(
...
$wp_customize->add_setting( 'top_store_product_slider_zero_padding', array(
                'default'               => false,
                'sanitize_callback'     => 'top_store_sanitize_checkbox',
            ) );
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'top_store_product_slider_zero_padding', array(
                'label'                 => esc_html__('Disable Content Padding', 'top-store-pro'),
                'type'                  => 'checkbox',
                'section'               => 'top_store_product_slide_section',
                'settings'              => 'top_store_product_slider_zero_padding',
            ) ) );
...
$wp_customize->add_control(new top_store_Misc_Control( $wp_customize, 'top_store_product_slider_doc',
        ...
        'section'    => 'top_store_product_slide_section',
        'type'      => 'doc-link',
        'url'       => 'https://themehunk.com/docs/top-store-pro/#product-carousel',
