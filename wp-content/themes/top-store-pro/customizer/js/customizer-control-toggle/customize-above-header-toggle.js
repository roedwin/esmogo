...
OPNControlTrigger.addHook( 'top-store-toggle-control', function( argument, api ) {
		OPNCustomizerToggles ['top_store_above_header_layout'] = [
		    {
				controls: [
					'top_store_above_header_col1_set',
					'top_store_above_header_col2_set',
				    'top_store_above_header_col3_set',
				    'top_store_col1_texthtml',
				    'top_store_col2_texthtml',
				    'top_store_col3_texthtml',
				    'top_store_col1_menu_redirect',
				    'top_store_col2_menu_redirect',
				    'top_store_col3_menu_redirect',
				    'top_store_col1_widget_redirect',
				    'top_store_col2_widget_redirect',
				    'top_store_col3_widget_redirect',
				    'top_store_col1_social_media_redirect',
				    'top_store_col2_social_media_redirect',
				    'top_store_col3_social_media_redirect',
				    'top_store_abv_hdr_hgt',
				    'top_store_abv_hdr_botm_brd',
				    'top_store_above_brdr_clr',
			...
			},
			{
				...
				callback: function(layout){
					var val = api( 'top_store_above_header_col1_set' ).get();
...
// col2
			{
				...
				callback: function(layout){
					var val = api( 'top_store_above_header_col2_set' ).get();
    ...
    // col3

            {
				...
				callback: function(layout){
					var val = api( 'top_store_above_header_col3_set' ).get();
		...
		OPNCustomizerToggles ['top_store_above_header_col1_set'] = [
		    
		    {
				...
				callback: function(layout){
                var val = api( 'top_store_above_header_layout' ).get();
		...
		OPNCustomizerToggles ['top_store_above_header_col2_set'] = [
		    {
				controls: [    
				'top_store_col2_texthtml',
				'top_store_col2_widget_redirect',
		...
		OPNCustomizerToggles ['top_store_above_header_col3_set'] = [
		    {
				controls: [    
				'top_store_col3_texthtml',
				'top_store_col3_widget_redirect',
