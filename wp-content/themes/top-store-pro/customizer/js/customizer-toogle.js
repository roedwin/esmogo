...
( function( $ ){
	...
	OPNControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'top-store-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'top-store-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'top-store-control-trigger.' + hook, callback );
	    },
	};
...
( function( $ ){
	...
	OPNCustomizer = {
		...
		_initToggles: function()
		{
			...
			OPNControlTrigger.triggerHook( 'top-store-toggle-control', api );
