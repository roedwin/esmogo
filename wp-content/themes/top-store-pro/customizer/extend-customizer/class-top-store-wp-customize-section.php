...
if ( class_exists( 'WP_Customize_Section' ) ) {
	...
	class  top_store_WP_Customize_Section extends WP_Customize_Section {
		...
		public function json() {
			...
			if ( $this->panel ) {
				$array['customizeAction'] = sprintf(__('Customizing &#9656; %s','top-store-pro'), esc_html( $this->manager->get_panel( $this->panel )->title ) );
			} else {
				$array['customizeAction'] = __('Customizing','top-store-pro');
			}
