 ...
 */
// add admin scripts
function top_store_widget_enqueue(){
    wp_enqueue_media();
}
add_action('admin_enqueue_scripts', 'top_store_widget_enqueue');
// register widget
function top_store_about_us_widget(){
register_widget( 'TopStore_aboutme' );
}
add_action('widgets_init','top_store_about_us_widget');
class TopStore_aboutme extends WP_Widget {
    function __construct() {
        $widget_ops = array('classname' => 'th-about-me',
            'description' => 'Display member image with description, link and font awesome icons');
        parent::__construct('th-about-me-widget', __('Top Store : About Us widget','top-store-pro'), $widget_ops);
    }
...
<p>
        <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title','top-store-pro'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('author_img_uri'); ?>"><?php _e('Member Image','top-store-pro'); ?></label>
        <?php
    ...
    <p>
        <label for="<?php echo $this->get_field_id('text'); ?>"><?php _e('About Me Description','top-store-pro'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('readtxt'); ?>"><?php _e('Read More Text','top-store-pro'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('readlink'); ?>"><?php _e('Link','top-store-pro'); ?></label></p><P>
   ...
   <br/><P>
        <label style="padding-bottom: 5px; padding-top:0px;font-size: 12px;font-style: italic;"><?php _e('Go to this link for <a target="_blank" href="//fontawesome.io/icons/">Fontawesome icons</a> and copy the class of icon that you need & paste it below.','top-store-pro'); ?></label></p>
        <P>
        <label for="<?php echo $this->get_field_id('icon1'); ?>"><?php _e('Fontawesome Social Icon-1','top-store-pro'); ?></label>
       </p>
        <P>
        ...
        <label for="<?php echo $this->get_field_id('icon1'); ?>"><?php _e('Social Icon Link','top-store-pro'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon2'); ?>"><?php _e('Fontawesome Social Icon-2','top-store-pro'); ?></label></p><P>
        ...
        <label for="<?php echo $this->get_field_id('icon2'); ?>"><?php _e('Social Icon Link','top-store-pro'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon3'); ?>"><?php _e('Fontawesome Social Icon-3','top-store-pro'); ?></label></p><P>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('icon3'); ?>" id="<?php echo $this->get_field_id('icon3'); ?>" value="<?php  if(isset($instance["icon3"])){ echo $instance['icon3']; } ?>" style="margin-top:5px;"></p><P>
         <label for="<?php echo $this->get_field_id('icon3'); ?>"><?php _e('Social Icon Link','top-store-pro'); ?></label></p><P>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('icon4'); ?>"><?php _e('Fontawesome Social Icon-4','top-store-pro'); ?></label></p><P>
        ...
        <label for="<?php echo $this->get_field_id('icon4'); ?>"><?php _e('Social Icon Link-4','top-store-pro'); ?></label></p><P>
