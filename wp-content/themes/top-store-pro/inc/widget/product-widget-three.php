<?php
/*
 *  PRODUCT-THREE-WIDGET
 */
// register widget
function top_store_pro_show_product_three_widget(){
    register_widget( 'top_storeproshowprd_three' );
}
add_action('widgets_init', 'top_store_pro_show_product_three_widget');
//  widget class
class top_storeproshowprd_three extends WP_Widget{
function __construct(){
    $widget_ops = array('classname' => 'top_storeproshowprd_three','description' => 'Show your Product');
        parent::__construct('top-store-showprd-three-widget', __('Top Store : Product List Slider widget','top-store-pro'), $widget_ops);
    }
    ...
    $widget_title_color = isset($instance['widget_title_color'])? $instance['widget_title_color']:'#080808';
    ...
    ?>
<style>
   .product-slide-widget.<?php echo $widget_id;?>  .owl-stage-outer{
    margin:0!important;
    padding:0!important;
   }
...
.product-slide-widget.<?php echo $widget_id;?> .owl-carousel .owl-nav {
    position: absolute;
    top:25%!important;
}
</style>
<div class="thunk-product-tab-list-section product-slide-widget small-product-slide-widget <?php echo $widget_id; ?>">  
...
<?php } ?>  
<div id="<?php echo $widget_id?>" class="thunk-slide slide-two-product featured-grid owl-carousel th-col-<?php echo $query['column_no']; ?>">
