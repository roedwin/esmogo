...
class TopStore_testimonial extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('th-testimonial-widget', __('Top Store : Testimonial Widget','top-store-pro'), $widget_ops);
    }
...
<div class="clearfix"></div>
    <p> 
        <label for="<?php echo $this->get_field_id('widgettitle'); ?>"><?php _e('Widget Title','top-store-pro'); ?></label> 
    ...
    <p>
        <label for="<?php echo $this->get_field_id('author_img_uri1'); ?>"><?php _e('Image','top-store-pro'); ?></label>
        <?php
...
<p>
        <label for="<?php echo $this->get_field_id('author_img_uri2'); ?>"><?php _e('Image','top-store-pro'); ?></label>
        <?php
    ...
    <p>
        <label for="<?php echo $this->get_field_id('author_img_uri3'); ?>"><?php _e('Image','top-store-pro'); ?></label>
        <?php
