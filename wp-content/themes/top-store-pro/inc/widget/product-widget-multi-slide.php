 ...
 */
// register widget
function top_store_pro_show_product_multi_slide_widget(){
register_widget( 'top_store_pro_show_multi_slide' );
}
add_action('widgets_init','top_store_pro_show_product_multi_slide_widget');
//  widget class
class top_store_pro_show_multi_slide extends WP_Widget{
function __construct(){
    $widget_ops = array('classname' => 'top_store_pro_show_multi_slide','description' => 'Show your Multi Product');
        parent::__construct('top-store-show-multi-slide', __('Top Store : Multi Product slider widget','top-store-pro'), $widget_ops);
    }
