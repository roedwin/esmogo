...
class top_store_highlights_column extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct('topstore-highlights-column-widget', __('Topstore : Highlight Widget','top-store-pro'), $widget_ops);
    }
...
<?php
    ...
    ?>
        ...
        <p> 
        <label for="<?php echo $this->get_field_id('widgettitle'); ?>"><?php _e('Widget Title ( Will be display in mobile view )','top-store-pro'); ?></label> 
      ...
      <p>
        <label for="<?php echo $this->get_field_id('title1'); ?>"><?php _e('Title','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('text1'); ?>"><?php _e('Description','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('fontaws1'); ?>"><?php _e('Font Awesome Icon','top-store-pro'); ?></label>
      ...
      <p>
        <label for="<?php echo $this->get_field_id('link1'); ?>"><?php _e('Link','top-store-pro'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('link1'); ?>" id="<?php echo $this->get_field_id('link1'); ?>" value="<?php  echo $link1; ?>" style="margin-top:5px;">
     </p>

     <p>
        <label for="<?php echo $this->get_field_id('title2'); ?>"><?php _e('Title','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('text2'); ?>"><?php _e('Description','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('fontaws2'); ?>"><?php _e('Font Awesome Icon','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('link2'); ?>"><?php _e('Link','top-store-pro'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('link2'); ?>" id="<?php echo $this->get_field_id('link2'); ?>" value="<?php  echo $link2; ?>" style="margin-top:5px;">
     </p>

     <p>
        <label for="<?php echo $this->get_field_id('title3'); ?>"><?php _e('Title','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('text3'); ?>"><?php _e('Description','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('fontaws3'); ?>"><?php _e('Font Awesome Icon','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('link3'); ?>"><?php _e('Link','top-store-pro'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('link3'); ?>" id="<?php echo $this->get_field_id('link3'); ?>" value="<?php  echo $link3; ?>" style="margin-top:5px;">
     </p>

     <p>
        <label for="<?php echo $this->get_field_id('title4'); ?>"><?php _e('Title','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('text4'); ?>"><?php _e('Description','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('fontaws4'); ?>"><?php _e('Font Awesome Icon','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('link4'); ?>"><?php _e('Link','top-store-pro'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('link4'); ?>" id="<?php echo $this->get_field_id('link4'); ?>" value="<?php  echo $link4; ?>" style="margin-top:5px;">
     </p>

     <p>
        <label for="<?php echo $this->get_field_id('title5'); ?>"><?php _e('Title','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('text5'); ?>"><?php _e('Description','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('fontaws5'); ?>"><?php _e('Font Awesome Icon','top-store-pro'); ?></label>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('link5'); ?>"><?php _e('Link','top-store-pro'); ?></label>
        <input type="text" class="widefat" name="<?php echo $this->get_field_name('link5'); ?>" id="<?php echo $this->get_field_id('link5'); ?>" value="<?php  echo $link5; ?>" style="margin-top:5px;">
     </p>  
