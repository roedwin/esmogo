...
class Themehunk_Library_WXR_Importer {
	...
	/**
	 * Instance of Themehunk_Library_WXR_Importer
	 *
	 * @since  1.0.0
	 * @var Themehunk_Library_WXR_Importer
	 */
	private static $_instance = null;

	/**
	 * Instantiate Themehunk_Library_WXR_Importer
	 *
	 * @since  1.0.0
	 * @return (Object) Themehunk_Library_WXR_Importer.
	 */
	...
	private function __construct() {
		...
		if ( ! class_exists( 'WP_Importer_Logger' ) ) {
			require_once THEMEHUNK_SITE_LIBRARY_DIR . 'importer/class-logger.php';
		}
		...
		if ( ! class_exists( 'WXR_Import_Info' ) ) {
			require_once THEMEHUNK_SITE_LIBRARY_DIR . 'importer/class-wxr-import-info.php';
		}
	...
	public function get_xml_data( $path ) {
		...
		return array(
			...
			'url'     => $url,
			'strings' => array(
				'complete' => __( 'Import complete!', 'top-store-pro' ),
			),
		);
	}
