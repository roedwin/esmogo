					...
					<div class="thunk-posts-description ">
						...
						<div class="thunk-post-comments">
							<div class="thunk-comments-icon">
								<span class="thunk-comments"><a href="<?php comments_link(); ?>" title=""><?php comments_popup_link(esc_html('0','top-store-pro'), esc_html('1','top-store-pro'), esc_html('%','top-store-pro')); ?></a></span>
							</div>
						</div>
					    </div>
						<div class="thunk-post-excerpt">
								<?php top_store_the_excerpt();?> 
						</div>
